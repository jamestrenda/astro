...
export const HomeHero = () => {
  ...
  const numItems = 8;
  return (
    <div className="h-[300vh] bg-black/5">
      <div ref={target} className="h-full relative">
        ...
        >
          <div className="max-md:[&>div]:!px-0 md:pt-4 pb-24 md:h-[768px] max-md:overflow-hidden">
            <Container>
              <BrowserWindow className="max-md:rounded-t-none" {...{ scrollY }}>
