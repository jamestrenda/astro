              ...
              {items?.map((item, i) => {
                return (
                  <AccordionItem
                    ...
                    className="[&[data-state=closed]>div]:h-0 lg:[&[data-state=closed]>div]:h-auto lg:border-b-0 dark:border-white/5 max-lg:last:border-none lg:border lg:border-solid lg:p-8 lg:rounded-lg"
                  >
