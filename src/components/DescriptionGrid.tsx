              ...
              {items?.map((item, i) => {
                return (
                  <AccordionItem
                    ...
                    className="backdrop-blur-md transition delay-75 hover:delay-0 dark:border-zinc-950 dark:bg-black/30 max-lg:-mx-4 max-lg:px-4 max-lg:last:border-none max-lg:hover:bg-gray-100 max-lg:data-[state=open]:bg-gray-100 max-lg:dark:hover:bg-black/20 max-lg:dark:data-[state=open]:bg-black/20 lg:rounded-lg lg:border lg:border-b-0 lg:border-solid lg:bg-gray-100 lg:p-8 lg:dark:bg-black/30 [&[data-state=closed]>div]:h-0 lg:[&[data-state=closed]>div]:h-auto"
                  >
