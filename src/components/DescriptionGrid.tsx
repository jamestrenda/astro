              ...
              {items?.map((item, i) => {
                return (
                  <AccordionItem
                    ...
                    className="[&[data-state=closed]>div]:h-0 lg:[&[data-state=closed]>div]:h-auto lg:border-b-0 dark:border-white/5 max-lg:last:border-none lg:border lg:border-solid lg:p-8 lg:rounded-lg lg:bg-indigo-50 max-lg:hover:bg-indigo-50  transition hover:delay-0 delay-75 max-lg:-mx-4 max-lg:px-4"
                  >
                    ...
                    <AccordionContent
                      forceMount
                      className="[&_p]:text-lg dark:text-white/50 max-lg:pr-12"
                    >
                      {item.description && (
