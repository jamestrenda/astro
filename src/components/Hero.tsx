    ...
    <div className="max-md:[&>div]:px-0! pb-15 relative">
      <Container>
        ...
        >
          ...
          />
          <div className="[&_p]:text-gray-500! z-60 col-span-11 mt-auto w-full space-y-3 text-lg leading-6 max-xs:mb-4 xs:col-start-1 xs:col-end-8 xs:mt-16 [&_p]:font-light dark:[&_p]:text-foreground sm:[&_p]:text-xl [&_p]:lg:max-w-[85%] lg:[&_p]:text-2xl">
            {valueProposition && (
