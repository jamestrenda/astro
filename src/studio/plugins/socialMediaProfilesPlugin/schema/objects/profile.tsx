...
import {
  ...
  RiUnsplashFill as UnsplashIcon,
...
const socialMediaOptions = [
  ...
  { title: "Unsplash", value: "unsplash", icon: UnsplashIcon },
...
export const profile = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: "Profile URL",
      description:
        "The full URL of your profile (e.g., https://instagram.com/username)",
    }),
    defineField({
      name: "handle",
      type: "string",
  ...
  preview: {
    ...
    prepare(selection) {
      ...
      const platform = socialMediaOptions.find(
