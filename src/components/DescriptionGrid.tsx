              ...
              {items?.map((item, i) => {
                return (
                  <AccordionItem
                    ...
                    className="[&[data-state=closed]>div]:h-0 [&[data-state=open]]:max-lg:dark:bg-zinc-950 lg:[&[data-state=closed]>div]:h-auto lg:border-b-0 max-lg:last:border-none lg:border lg:border-solid lg:p-8 lg:rounded-lg lg:bg-indigo-50 lg:dark:bg-black/30 dark:border-zinc-950 max-lg:hover:bg-indigo-50 max-lg:hover:dark:bg-zinc-800  transition hover:delay-0 delay-75 max-lg:-mx-4 max-lg:px-4"
                  >
