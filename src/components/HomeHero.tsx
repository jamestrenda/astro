...
export const HomeHero = () => {
  ...
  return (
    <div className="h-[300vh]">
      ...
      >
        <div className="max-md:[&>div]:!px-0 md:pt-4 bg-black/10 dark:bg-black/20 pb-24 md:h-[768px] max-md:overflow-hidden">
          <Container>
              ...
              <div className="w-full min-[480px]:w-4/5 xs:w-1/2 mt-16">
                ...
                <FadeIn delay={4}>
                  <p className="text-background dark:text-foreground text-lg md:text-xl fade-in font-light">
                    Helping today's visionaries <em>(psst—that's you)</em> build
                    a better tomorrow by turning ideas into online interactive
                    experiences.
                  </p>
                </FadeIn>
              </div>
