  ...
  return (
    <div className="relative">
      ...
      <Container padding={true}>
        <div className="text-muted [&_p]:max-w-5xl [&_p]:text-xl [&_p]:font-light md:[&_p]:text-2xl">
              ...
              {items?.map((item, i) => {
                return (
                  <AccordionItem
                    ...
                    className="transition delay-75 hover:delay-0 dark:border-zinc-950 max-lg:-mx-4 max-lg:px-4 max-lg:last:border-none max-lg:hover:bg-indigo-50 max-lg:dark:hover:bg-zinc-800 max-lg:dark:data-[state=open]:bg-zinc-950 lg:rounded-lg lg:border lg:border-b-0 lg:border-solid lg:bg-indigo-50 lg:p-8 lg:dark:bg-black/30 [&[data-state=closed]>div]:h-0 lg:[&[data-state=closed]>div]:h-auto"
                  >
                    ...
                    <AccordionContent
                      forceMount
                      className="dark:text-muted max-lg:pr-12 [&_p]:text-lg"
                    >
                      {item.description && (
